...
void MacOSGUI::_drawDeviceDiscovery()
{
...
void MacOSGUI::_drawASMControls()
{
...
MacOSGUI::MacOSGUI(BluetoothWrapper bt) : _bt(std::move(bt))
{
	// bt.getConnectedDevices();
